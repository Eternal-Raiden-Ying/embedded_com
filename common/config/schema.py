...
class ControlThresholds:
    ...
    edge_handoff_forward_vx_mps: float = 0.018
    ...
    lateral_vy_max_mps: float = 0.015
    lateral_deadband_norm: float = 0.035
    lateral_kp: float = 0.065
