...
class VisionRuntimeConfig:
    ...
    remote_rgb_correction_mode: str = "auto_level_gamma"
    remote_rgb_gamma: float = 1.8
    remote_rgb_percentile_low: float = 1.0
    remote_rgb_percentile_high: float = 99.0
    remote_rgb_max_gain: float = 3.0
