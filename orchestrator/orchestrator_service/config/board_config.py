...
def _sync_table_motion_norms() -> None:
    CONFIG.car.table_vx_norm_min = abs(float(CONFIG.car.table_controlled_vx_min_mps)) / max(1e-6, abs(float(CONFIG.car.vx_mps_per_norm)))
    CONFIG.car.table_vx_norm_max = abs(float(CONFIG.car.table_controlled_vx_max_mps)) / max(1e-6, abs(float(CONFIG.car.vx_mps_per_norm)))
    CONFIG.car.table_vy_max_norm = abs(float(CONFIG.car.table_controlled_vy_max_mps)) / max(1e-6, abs(float(CONFIG.car.vy_mps_per_norm)))
    CONFIG.car.table_wz_view_max_norm = abs(float(CONFIG.car.table_controlled_wz_max_radps)) / max(1e-6, abs(float(CONFIG.car.wz_radps_per_norm)))
    CONFIG.car.table_wz_plane_max_norm = abs(float(CONFIG.car.table_coarse_align_wz_max_radps)) / max(1e-6, abs(float(CONFIG.car.wz_radps_per_norm)))
...
def _apply_stage_params(data: Dict[str, Any]) -> None:
    ...
    CONFIG.car.table_stage_a_wz_norm = float(controlled.get("stage_a_wz_norm", CONFIG.car.table_stage_a_wz_norm))
    CONFIG.car.table_stage_b_vx_max_norm = float(controlled.get("stage_b_vx_max_norm", CONFIG.car.table_stage_b_vx_max_norm))
    CONFIG.car.table_stage_c_vx_max_norm = float(controlled.get("stage_c_vx_max_norm", CONFIG.car.table_stage_c_vx_max_norm))
    ...
    CONFIG.car.table_vx_norm_min = float(controlled.get("vx_norm_min", controlled.get("min_vx_norm", CONFIG.car.table_vx_norm_min)))
    CONFIG.car.table_vx_norm_max = float(controlled.get("vx_norm_max", controlled.get("max_vx_norm", CONFIG.car.table_vx_norm_max)))
    CONFIG.car.table_vx_kp_norm_per_m = float(controlled.get("vx_kp_norm_per_m", controlled.get("dist_kp", CONFIG.car.table_vx_kp_norm_per_m)))
    ...
    CONFIG.car.table_vy_max_norm = float(controlled.get("view_vy_max_norm", CONFIG.car.table_vy_max_norm))
    CONFIG.car.table_wz_view_max_norm = float(controlled.get("view_wz_max_norm", CONFIG.car.table_wz_view_max_norm))
    CONFIG.car.table_wz_plane_max_norm = float(controlled.get("plane_wz_max_norm", CONFIG.car.table_wz_plane_max_norm))
    CONFIG.car.table_view_recover_vy_norm = float(controlled.get("view_recover_vy_norm", CONFIG.car.table_view_recover_vy_norm))
    CONFIG.car.table_view_recover_wz_norm = float(controlled.get("view_recover_wz_norm", CONFIG.car.table_view_recover_wz_norm))
...
CONFIG.car.table_vx_norm_min = _env_float("ORCH_TABLE_VX_NORM_MIN", CONFIG.car.table_vx_norm_min)
CONFIG.car.table_vx_norm_max = _env_float("ORCH_TABLE_VX_NORM_MAX", CONFIG.car.table_vx_norm_max)
CONFIG.car.table_vx_kp_norm_per_m = _env_float("ORCH_TABLE_VX_KP_NORM_PER_M", CONFIG.car.table_vx_kp_norm_per_m)
...
CONFIG.car.table_view_recover_vy_norm = _env_float("ORCH_TABLE_VIEW_RECOVER_VY_NORM", CONFIG.car.table_view_recover_vy_norm)
CONFIG.car.table_view_recover_wz_norm = _env_float("ORCH_TABLE_VIEW_RECOVER_WZ_NORM", CONFIG.car.table_view_recover_wz_norm)
...
CONFIG.car.vx_mps_per_norm = _env_float("ORCH_VX_MPS_PER_NORM", CONFIG.car.vx_mps_per_norm)
CONFIG.car.vy_mps_per_norm = _env_float("ORCH_VY_MPS_PER_NORM", CONFIG.car.vy_mps_per_norm)
CONFIG.car.wz_radps_per_norm = _env_float("ORCH_WZ_RADPS_PER_NORM", CONFIG.car.wz_radps_per_norm)
_sync_table_motion_norms()
