...
class ControlThresholds:
    ...
    near_slow_max_vy_mps: float = 0.015
    ...
    depth_envelope_slow_vx_mps: float = 0.030
    depth_envelope_mid_vx_mps: float = 0.080
    ...
    near_lateral_vy_max_mps: float = 0.015
    ...
    final_forward_vx_max_mps: float = 0.030
    final_reverse_vx_max_mps: float = 0.020
