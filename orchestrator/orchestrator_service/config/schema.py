...
class CarMotionConfig:
    ...
    table_coarse_align_vy_min_mps: float = 0.010
    table_coarse_align_vy_max_mps: float = 0.025
    table_coarse_align_wz_min_radps: float = 0.020
    table_coarse_align_wz_max_radps: float = 0.060
    table_controlled_vx_min_mps: float = 0.015
    table_controlled_vx_max_mps: float = 0.030
    table_controlled_vy_min_mps: float = 0.008
    table_controlled_vy_max_mps: float = 0.020
    table_controlled_wz_min_radps: float = 0.015
    table_controlled_wz_max_radps: float = 0.050
    table_approach_safe_vx_mps: float = 0.015
    table_approach_max_vx_mps: float = 0.030
    table_approach_yaw_deadband_rad: float = 0.08
    table_approach_yaw_realign_rad: float = 0.12
    table_approach_allow_wz: bool = False
    table_approach_allow_vy: bool = False
    table_pose_missing_safe_vx_mps: float = 0.015
