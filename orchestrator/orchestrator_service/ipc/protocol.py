...
class TableEdgeObs:
    ...
    control_bbox_age_ms: Optional[float] = None
    bbox_hold_reason: Optional[str] = None
    ...
    def from_dict(cls, payload: Dict[str, Any]) -> "TableEdgeObs":
        ...
        return cls(
            ...
            inference_age_ms=_pick_optional_float(payload, "inference_age_ms"),
            has_new_inference=_pick_optional_bool(payload, "has_new_inference"),
            explicit_negative_detection=bool(payload.get("explicit_negative_detection", payload.get("explicit_negative", False))),
            control_bbox_age_ms=_pick_optional_float(payload, "control_bbox_age_ms", "yolo_table_age_ms"),
            bbox_hold_reason=_pick_optional_str(payload, "bbox_hold_reason"),
...
class TargetObs:
    ...
    target_candidate_confidences: Optional[list] = None
    ...
    def from_dict(cls, payload: Dict[str, Any]) -> "TargetObs":
        ...
        return cls(
            ...
            target_candidate_confidences=payload.get("target_candidate_confidences"),
