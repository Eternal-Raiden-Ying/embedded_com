    ...
    def _apply_control_authority(self, decision: MotionDecision, obs: Optional[TableEdgeObs], *, explicit_stop_active: bool = False) -> MotionDecision:
        ...
        summary.update({
            **geom, "bbox_yaw_cmd": float(bbox_wz),
            ...
            "close_range_missing_probe_vx_mps": float(getattr(self.cfg, "close_range_missing_probe_vx_mps", 0.002) or 0.002),
            ...
            "lateral_vy_max_mps": float(getattr(self.cfg, "lateral_vy_max_mps", 0.150) or 0.150),
            "lateral_deadband_norm": float(getattr(self.cfg, "lateral_deadband_norm", 0.025) or 0.025),
            "lateral_kp": float(getattr(self.cfg, "lateral_kp", 0.100) or 0.100),
