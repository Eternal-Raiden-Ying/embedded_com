...
class DockingAction(str, Enum):
    ...
    TARGET_LATERAL_ALIGN = "TARGET_LATERAL_ALIGN"
...
class DockingMotionResult:
    ...
    def _owner_defaults(self) -> tuple[str, str, str]:
        ...
        mapping = {
            ...
            DockingAction.BBOX_TRACK_FORWARD: ("bbox", "bbox_track", "bbox_view"),
            DockingAction.EDGE_READINESS_HANDOFF: ("bbox", "bbox_track", "bbox_view"),
            DockingAction.EDGE_APPROACH_FORWARD: ("edge", "edge_approach", "bbox_view"),
            DockingAction.NEAR_EDGE_FORWARD: (yaw or "last_good_edge", "near_edge", "bbox_view"),
