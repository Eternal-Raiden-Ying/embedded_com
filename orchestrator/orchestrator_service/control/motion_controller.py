...
class MotionController:
    ...
    def yolo_table_search_cmd(
        ...
        *,
        ...
        speed_band = "default"
        speed_depth = None
        selected_vx = forward_vx
        if mode_name == "YOLO_APPROACH":
            for depth_value in (
            ...
            if speed_depth is None:
                speed_band = "min"
                selected_vx = min_vx
            elif speed_depth > 1.20:
                speed_band = "far"
                selected_vx = far_vx
            elif speed_depth >= 0.90:
                speed_band = "mid"
                selected_vx = mid_vx
            elif speed_depth >= 0.65:
                speed_band = "near"
                selected_vx = near_vx
            else:
                speed_band = "min"
                selected_vx = min_vx
            forward_vx = max(min_vx, selected_vx)
