...
# Add project roots to PYTHONPATH dynamically if run as a script directly
    ...
    for wf_path in wav_files:
        ...
        try:
            ...
            if send_task and asr_result.get("status") == "OK":
                ...
                from voice_service.service import build_task_sender
...
def main():
    ...
    # Check for replay flags before full loader
    import argparse
