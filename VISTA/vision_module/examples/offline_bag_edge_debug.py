...
def _table_edge_payload(
    ...
    payload = {
        ...
        "plane_only_mode": bool(getattr(cfg, "plane_only_mode", False)),
        "enable_crease_line": bool(getattr(cfg, "enable_crease_line", True)),
        "age_ms": float(age_ms),
...
def _csv_row(table_edge: Dict[str, Any], frame_id: int, ts_ms: float, roi_preset: str, target_dist_m: float) -> Dict[str, Any]:
    ...
    return {
        ...
        "target_dist_m": float(target_dist_m),
        "plane_only_mode": int(bool(table_edge.get("plane_only_mode"))),
        "enable_crease_line": int(bool(table_edge.get("enable_crease_line"))),
