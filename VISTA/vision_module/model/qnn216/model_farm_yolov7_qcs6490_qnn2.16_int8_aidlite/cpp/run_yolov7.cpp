...
const float anchor0[6] = {12,16, 19,36, 40,28};
const float anchor1[6] = {36,75, 76,55, 72,146};
const float anchor2[6] = {142,110, 192,243, 459,401};
...
int32_t thread_func(int thread_idx){
	...
	std::string model_path = "../../models/cutoff_yolov7_w8a8.qnn216.ctx.bin";
