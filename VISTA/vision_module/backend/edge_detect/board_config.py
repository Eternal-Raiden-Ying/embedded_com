...
CONFIG.runtime.runs_dir = _env_str("EDGE_RUNS_DIR", str(Path(CONFIG.runtime.project_root) / "runs"))
CONFIG.runtime.pid_dir = _env_str("EDGE_PID_DIR", str(Path(CONFIG.runtime.project_root) / "pids"))
...
CONFIG.runtime.snapshot_dir = _env_str("EDGE_SNAPSHOT_DIR", str(Path(CONFIG.runtime.project_root) / "snapshots"))
...
CONFIG.detector.calib_json = _env_str("EDGE_CALIB_JSON", _DEFAULT_CALIB)
